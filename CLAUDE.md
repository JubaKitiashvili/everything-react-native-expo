...
| `debug-video`             | Video file (.mp4, .mov, .webm), screen recording, "animation bug", "watch this video", "here's a recording", "gesture not working" + video, "scroll jank" + video, "keyboard covers" + video, "transition glitch", "race condition" + video, "flicker", "flash of wrong content"                                                                                             |
