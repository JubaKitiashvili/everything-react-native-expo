---
description: Mobile security rules for React Native applications — AsyncStorage (non-encrypted), app integrity (SDK 54+)
globs: '**/*.{ts,tsx,js,jsx}'
alwaysApply: false
---
...
## App Integrity (Expo SDK 54+)

- Use `expo-app-integrity` for app authenticity verification
- **DeviceCheck** on iOS, **Play Integrity API** on Android
- Verify requests come from genuine app installs, not tampered builds
